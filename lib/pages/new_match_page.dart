            ...
            children: [
              Container(
                ...
                child: PopInAnimation(
                  ...
                  explodeLeft: true,
                  child: AvatarWithGradientBorder(image: NetworkImage(currentUser!.firstImgUrl),radius: 66,backgroundColor: Colors.red,borderWidth: 5.5,isBlue: false),
                )
              ),
              PopInAnimation(
                ...
                duration: const Duration(milliseconds: 1200),
                explodeLeft: false,
                child: AvatarWithGradientBorder(image: NetworkImage(otherUser!.firstImgUrl),radius: 66,backgroundColor: Colors.red,borderWidth: 5.5,isBlue: false,),
              )
            ]
          ),
          const Spacer(),
