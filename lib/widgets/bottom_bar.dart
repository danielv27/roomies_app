...
class BottomBar extends StatelessWidget {
  ...
  BottomBar({
    ...
    this.itemPadding = const EdgeInsets.symmetric(vertical: 10, horizontal: 22),
    required this.items,
    required this.onTap,
        ...
        child: Row(
          ...
          children: List.generate(
            ...
            (int index) {
              ...
              final _selectedColorWithOpacity = _selectedColor.withOpacity(0.3);
              ...
              return Container(
                child: (index != selectedIndex)?
                  ...
                  selectedColorWithOpacity: Colors.transparent,
